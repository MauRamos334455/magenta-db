...
CREATE TABLE DIPLOMA(
    DIPLOMA_ID    NUMERIC(40, 0)   NOT NULL DEFAULT DIPLOMA_SEQ.NEXTVAL,
    NAME          VARCHAR(300)    NOT NULL,
...
CREATE TABLE PROFESSOR(
    ...
    CONSTRAINT PROFESSOR_PROVENANCE_CHK CHECK ((IS_UNAM = FALSE AND PROVENANCE NOT NULL) OR IS_UNAM = TRUE),
...
CREATE TABLE VENUE(
    VENUE_ID    NUMERIC(40, 0)   NOT NULL DEFAULT VENUE_SEQ.NEXTVAL,
    NAME        VARCHAR(100)    NOT NULL,
