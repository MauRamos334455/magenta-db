...
CREATE TABLE ACTIVITY(
    ACTIVITY_ID              NUMBER(40, 0)    NOT NULL DEFAULT ACTIVITY_SEQ.NEXTVAL,
    ...
    CONSTRAINT ACTIVITY_DAY_CHK CHECK (REGEXP_LIKE(DAY, '^\[(L,)?(M,)?(I,)?(J,)?(V,)?(S,)?(D,)?\]$')),
...
CREATE TABLE ACTIVITY_CATALOGUE(
    ACTIVITY_CATALOGUE_ID    NUMBER(40, 0)     NOT NULL DEFAULT ACTIVITY_CATALOGUE_SEQ.NEXTVAL,
...
CREATE TABLE ACTIVITY_EVALUATION(
    ACTIVITY_EVALUATION_ID    NUMBER(40, 0)    NOT NULL DEFAULT ACTIVITY_EVALUATION_SEQ.NEXTVAL,
    ...
    CONSTRAINT AE_QUESTION_5_CHK CHECK (REGEXP_LIKE(QUESTION_5, '^\[(I,)?(F,)?(J,)?(O,)?\]$')),
    CONSTRAINT AE_QUESTION_9_CHK CHECK (REGEXP_LIKE(QUESTION_9, '^\[(P,)?(H,)?(C,)?(I,)?(O,)?\]$'))
)
;
...
CREATE TABLE ADMINISTRATOR(
    ADMINISTRATOR_ID     NUMBER(10, 0)    NOT NULL DEFAULT ADMINISTRATOR_SEQ.NEXTVAL,
...
CREATE TABLE CAREER(
    CAREER_ID    NUMBER(10, 0)    NOT NULL DEFAULT CAREER_SEQ.NEXTVAL,
    NAME         VARCHAR2(100)    NOT NULL,
    KEY          VARCHAR2(30)     NOT NULL,
...
CREATE TABLE CATEGORY(
    CATEGORY_ID     NUMBER(10, 0)    NOT NULL DEFAULT CATEGORY_SEQ.NEXTVAL,
...
CREATE TABLE DEPARTMENT(
    DEPARTMENT_ID       NUMBER(10, 0)    NOT NULL DEFAULT DEPARTMENT_SEQ.NEXTVAL,
...
CREATE TABLE DIPLOMA(
    DIPLOMA_ID    NUMBER(20, 0)    NOT NULL DEFAULT DIPLOMA_SEQ.NEXTVAL,
    NAME          VARCHAR2(300)    NOT NULL,
...
CREATE TABLE DIVISION(
    DIVISION_ID     NUMBER(10, 0)    NOT NULL DEFAULT DIVISION_SEQ.NEXTVAL,
...
CREATE TABLE FACULTY(
    FACULTY_ID    NUMBER(10, 0)    NOT NULL DEFAULT FACULTY_SEQ.NEXTVAL,
    NAME          VARCHAR2(50)     NOT NULL,
...
CREATE TABLE INSTRUCTOR(
    INSTRUCTOR_ID    NUMBER(40, 0)    NOT NULL DEFAULT INSTRUCTOR_SEQ.NEXTVAL,
    KEY              VARCHAR2(10),
    SEND_DATE        DATE,
    PROFESSOR_ID     NUMBER(40, 0)    NOT NULL,
    ACTIVITY_ID      NUMBER(40, 0)    NOT NULL,
    CONSTRAINT INSTRUCTOR_PK PRIMARY KEY (INSTRUCTOR_ID),
    CONSTRAINT INSTRUCTOR_KEY_CHK CHECK ( REGEXP_LIKE(KEY, '^F04[0-9]{4}[CTSDEF][0-9]{3}R[0-9]{4}$') ),
...
CREATE TABLE INSTRUCTOR_EVALUATION(
    INSTRUCTOR_EVALUATION_ID    NUMBER(40, 0)    NOT NULL DEFAULT INSTRUCTOR_EVALUATION_SEQ.NEXTVAL,
...
CREATE TABLE PARTICIPANT(
    PARTICIPANT_ID    NUMBER(40, 0)    NOT NULL DEFAULT PARTICIPANT_SEQ.NEXTVAL,
    ADDITIONAL        NUMBER(1, 0)     NOT NULL,
    ATTENDANCE        NUMBER(1, 0)     NOT NULL,
    ACCREDITED        NUMBER(1, 0)     NOT NULL,
    ...
    CONSTRAINT PARTICIPANT_KEY_CHK CHECK ( REGEXP_LIKE(KEY, '^F04[0-9]{4}[CTSDEF][0-9]{3}C[0-9]{4}$') )
)
;
...
CREATE TABLE PROFESSOR(
    PROFESSOR_ID         NUMBER(40, 0)    NOT NULL DEFAULT PROFESSOR_SEQ.NEXTVAL,
    NAME                 VARCHAR2(100)    NOT NULL,
...
CREATE TABLE PROFESSOR_CAREER(
    PROFESSOR_CAREER_ID    NUMBER(40, 0)    NOT NULL DEFAULT PROFESSOR_CAREER_SEQ.NEXTVAL,
...
CREATE TABLE PROFESSOR_CATEGORY(
    PROFESSOR_CATEGORY_ID    NUMBER(40, 0)    NOT NULL DEFAULT PROFESSOR_CATEGORY_SEQ.NEXTVAL,
...
CREATE TABLE PROFESSOR_DIVISION(
    PROFESSOR_DIVISION_ID    NUMBER(40, 0)    NOT NULL DEFAULT PROFESSOR_DIVISION_SEQ.NEXTVAL,
...
CREATE TABLE PROFESSOR_FACULTY(
    PROFESSOR_FACULTY_ID    VARCHAR2(40)     NOT NULL DEFAULT PROFESSOR_FACULTY_SEQ.NEXTVAL,
    PROFESSOR_ID            NUMBER(40, 0)    NOT NULL,
...
CREATE TABLE SEMINAR_TOPIC(
    SEMINAR_TOPIC_ID    VARCHAR2(40)     NOT NULL DEFAULT SEMINAR_TOPIC_SEQ.NEXTVAL,
    NAME                VARCHAR2(300)    NOT NULL,
    HOURS               NUMBER(3, 0)     NOT NULL,
...
CREATE TABLE USER(
    USER_ID          NUMBER(40, 0)    NOT NULL DEFAULT USER_SEQ.NEXTVAL,
    NAME             VARCHAR2(50)     NOT NULL,
...
CREATE TABLE VENUE(
    VENUE_ID    NUMBER(20, 0)    NOT NULL DEFAULT VENUE_SEQ.NEXTVAL,
    NAME        VARCHAR2(100)    NOT NULL,
