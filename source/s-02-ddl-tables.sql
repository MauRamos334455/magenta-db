...
CREATE TABLE ADMINISTRATOR(
    ...
    CONSTRAINT ADMINISTRATOR_PRIVELEGES_CHK CHECK(
      (ADMIN = TRUE) OR ( ADMIN = FALSE AND DEPARTMENT_ID IS NOT NULL)
    )
)
;
...
ALTER TABLE ACCOUNT ADD CONSTRAINT ADMINISTRATOR_DEPARTMENT_ID_FK
    FOREIGN KEY (ADMINISTRATOR_ID)
    REFERENCES DEPARTMENT(ADMINISTRATOR_ID)
    ON DELETE CASCADE
;