...
CREATE TABLE ACTIVITY_EVALUATION(
    ...
    CONSTRAINT AE_QUESTION_9_CHK CHECK (QUESTION_7_1 ~ '^P?H?C?O?$')
)
;
...
CREATE TABLE INSTRUCTOR_EVALUATION(
    ...
    CONSTRAINT IE_QUESTION_9_CHK  CHECK (QUESTION_9 IN (50,60,80,95,100)),
    CONSTRAINT IE_QUESTION_10_CHK CHECK (QUESTION_10 IN (50,60,80,95,100)),
    CONSTRAINT IE_QUESTION_11_CHK CHECK (QUESTION_11 IN (50,60,80,95,100))
)
;
